    ...
    try:
        while True:
                ...
                if input==0:
                    ...
                    for i in range(2):
                        sleep(1)
                        camera.capture('/home/itachi/Desktop/SmartSurveillance/Captured/image%s.jpg' % i) #Here replace with the path with your own path where the file would be present
